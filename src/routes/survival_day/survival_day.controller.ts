import { Game, GameDifficulty, SurvivalDayOption } from "@prisma/client"
...
export function getDuration(game: Pick<Game, 'min_duration_in_seconds' | 'max_duration_in_seconds'>, difficulty: GameDifficulty) {
    const difference = game.max_duration_in_seconds - game.min_duration_in_seconds
    switch (difficulty) {
        case 'easy':
            return game.min_duration_in_seconds + (60 * getRandomValue(0, 3))
        case 'medium':
            return Math.floor(game.min_duration_in_seconds + (difference / 2) + (60 * getRandomValue(0, 3)))
        case 'hard':
            return Math.floor(game.max_duration_in_seconds - (60 * getRandomValue(0, 3)))
    }
}
...
export async function generateNextDayOptions(game: Pick<Game, 'min_duration_in_seconds' | 'max_duration_in_seconds'>) {
    ...
    options.push({
        ...
        duration_in_seconds: getDuration(game, 'easy')
    })
    options.push({
        difficulty: 'medium',
        ...
        duration_in_seconds: getDuration(game, 'medium')
    })
    options.push({
        difficulty: 'hard',
        ...
        duration_in_seconds: getDuration(game, 'hard')
    })
    options.push({
        difficulty: 'rest',
