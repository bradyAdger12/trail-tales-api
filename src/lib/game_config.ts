...
export const hardStoryOptions: StoryOption[] = [
  { name: "Build a makeshift shelter and gather medicinal plants", difficulty: "hard", canFindFood: false, canFindWater: true, canFindHealth: true },
  { name: "Climb the hill for a better view and hunt small game", difficulty: "hard", canFindFood: true, canFindWater: true, canFindHealth: false },
  { name: "Hunt small animals and find fresh water source", difficulty: "hard", canFindFood: true, canFindWater: true, canFindHealth: false },
  { name: "Venture deeper into the jungle and treat wounds with healing plants", difficulty: "hard", canFindFood: true, canFindWater: false, canFindHealth: true },
  { name: "Set up a signal using wreckage parts and forage for food", difficulty: "hard", canFindFood: true, canFindWater: false, canFindHealth: true },
  { name: "Inspect the coastline for shellfish and fresh water pools", difficulty: "hard", canFindFood: true, canFindWater: true, canFindHealth: false },
  { name: "Explore a nearby cave and tend to injuries with natural remedies", difficulty: "hard", canFindFood: true, canFindWater: false, canFindHealth: true },
  { name: "Attempt to repair a broken radio while collecting rainwater", difficulty: "hard", canFindFood: true, canFindWater: true, canFindHealth: false },
  { name: "Scale dangerous cliffs to reach a hidden waterfall and treat wounds", difficulty: "hard", canFindFood: false, canFindWater: true, canFindHealth: true },
  { name: "Navigate through thorny undergrowth to find healing plants and forage for food", difficulty: "hard", canFindFood: true, canFindWater: false, canFindHealth: true },
  { name: "Risk crossing a fast-moving river to access fruit trees and fresh water", difficulty: "hard", canFindFood: true, canFindWater: true, canFindHealth: false },
]
